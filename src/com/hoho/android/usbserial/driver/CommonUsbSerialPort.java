...
public abstract class CommonUsbSerialPort implements UsbSerialPort {
    ...
    // Named class instead of a method reference (UsbRequest::new) - this project's javac/d8
    // pipeline has no desugaring support for synthetic lambda/method-reference classes.
    private static class DefaultUsbRequestSupplier implements UsbUtils.Supplier<UsbRequest> {
        public UsbRequest get() { return new UsbRequest(); }
    }
    protected UsbUtils.Supplier<UsbRequest> mUsbRequestSupplier = new DefaultUsbRequestSupplier(); // override for testing
