...
struct cdc_dev_s {
    ...
    volatile bool rx_paused;              // PrintHost: bulk IN polling is intentionally stopped (see cdc_acm_host_rx_pause)
    volatile bool rx_active;              // PrintHost: a bulk IN transfer is currently submitted
    struct {
