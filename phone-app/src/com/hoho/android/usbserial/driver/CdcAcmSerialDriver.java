...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    public class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        // Named class instead of a method reference (this::readControlLinesThreadFunction) -
        // this project's javac/d8 pipeline has no desugaring support for lambdas/method refs.
        private class ControlLinesRunnable implements Runnable {
            public void run() { readControlLinesThreadFunction(); }
        }
        ...
        private int getSerialState() throws IOException {
            ...
            if (mReadControlLinesThread == null) {
                synchronized (mReadControlLinesThreadLock) {
                    if (mReadControlLinesThread == null) {
                        mSerialState = 0;
                        mReadControlLinesThread = new Thread(new ControlLinesRunnable());
