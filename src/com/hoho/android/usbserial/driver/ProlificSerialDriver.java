...
public class ProlificSerialDriver implements UsbSerialDriver {
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        // Named class instead of a method reference (this::readStatusThreadFunction) - this
        // project's javac/d8 pipeline has no desugaring support for lambdas/method refs.
        private class StatusThreadRunnable implements Runnable {
            public void run() { readStatusThreadFunction(); }
        }
            ...
            if (mReadStatusThread == null) {
                synchronized (mReadStatusThreadLock) {
                    if (mReadStatusThread == null) {
                        ...
                        mReadStatusThread = new Thread(new StatusThreadRunnable());
